            ...
            <div className="relative flex-center flex-col w-fit h-fit">
                ...
                <div className="flex-col flex-center abs-center gap-2 top-[62%]">
                    <Popover>
                        <PopoverTrigger
                            className={cn([
                                "rounded-full p-4 !min-w-20 h-20 aspect-square -translate-y-0.5 group relative",
                        ...
                        <PopoverContent
                            className={"bg-primary text-white be-vietnam-pro-regular flex flex-col gap-5 p-4 rounded-2xl"}>
