...
// Select Components - Reusable select/dropdown components
// Cung cấp các select đẹp mắt cho form fields với nhiều options
...
>(({ className, children, ...props }, ref) => (
    <SelectPrimitive.Item
        ref={ref}
        className={cn(
            "relative flex w-full select-none items-center rounded-sm py-2 pl-8 pr-2 text-sm",
