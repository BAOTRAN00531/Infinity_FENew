    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-blue-100 dark:from-gray-900 dark:to-gray-800 px-4">
            ...
            >
                ...
                {/* Tiêu đề */}
                <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-4">Xác nhận Email</h2>
                ...
                <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
                    ...
                    Đừng quên kiểm tra cả thư mục{" "}
                    <span className="font-medium text-gray-800 dark:text-gray-200">Spam / Quảng cáo</span> nếu
                    không thấy.
                </p>
