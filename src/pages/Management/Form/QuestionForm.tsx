  ...
  import {
    ...
    AnswerCreateDto,
    QuestionDto
  } from '@/api/types'; // hoặc '@/types' nếu gộp chung
  ...
  import { UIQuestion } from '@/api/types';
  import {mapQuestionDtoToUIQuestion} from "@/api/index"; // ✅ Thêm nếu thiếu
  import WordSuggestion from '@/pages/Management/WordSuggestion'; // Đảm bảo đúng đường dẫn
  import { BookOpen } from 'lucide-react';
  import { Dialog, DialogContent } from '@/components/reuseables/Management/build/dialog';
  import api from "@/api/api";
  import { fetchLanguages, fetchModulesByLanguage, Language, ModuleLite } from '@/api/Management/adminQuestionApi';
  import { lexiconApi } from '@/api/Management/lexiconApi'; // ✅ Thêm import lexiconApi
