...
import { getCoursesByLanguage, getCourseById } from '@/api/Management/course.service';
import { fetchLanguages, fetchModules, fetchModuleById } from '@/api/Management/module.service';
import {Course, Language, Module, Part, PartRequest} from '@/api/types';
