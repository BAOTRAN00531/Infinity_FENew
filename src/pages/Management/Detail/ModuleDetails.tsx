...
// ModuleDetails - Component hiển thị chi tiết module
// Hiển thị thông tin đầy đủ về module với UI đẹp mắt
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3 p-4 bg-yellow-50 rounded-2xl">
              ...
              <div>
                ...
                <p className="font-bold text-gray-800">{module.duration || 'N/A'}</p>
              </div>
            </div>
