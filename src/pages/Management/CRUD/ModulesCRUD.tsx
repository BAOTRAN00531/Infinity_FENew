...
import { Module, ModuleRequest } from '@/api/types';

import ModuleDetails from '@/pages/Management/Detail/ModuleDetails';
import DeleteConfirmation from '@/pages/Management/DeleteConfirmation';
import { fetchModules, createModule, updateModule, deleteModule } from '@/api/Management/module.service';
